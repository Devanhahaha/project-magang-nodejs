...
const dashboardQaController = require('../../controllers/dashboard/qualityassurance/dashboardQaController');
...
router.get('/', ensureCaptchaVerified, authMiddleware, roleMiddleware.isQa, dashboardQaController.index);
