...
const dashboardDeveloperController = require('../../controllers/dashboard/developer/dashboardDeveloperController');
...
router.get('/', ensureCaptchaVerified, authMiddleware, roleMiddleware.isDeveloper, dashboardDeveloperController.index);
