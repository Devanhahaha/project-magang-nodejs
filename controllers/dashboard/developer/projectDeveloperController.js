...
exports.index = async (req, res) => {
    try {
      ...
      const projects = await Project.findAll({
        where: {
          developer_id: userLoginId // ⬅️ Filter hanya project milik developer ini
        },
        include: [
          { model: User, as: 'admin' },
      ...
      res.render('dashboard/developerpage/project/index', {
        title: 'Projects',
...
exports.showByName = async (req, res) => {
  try {
    ...
    res.render('dashboard/developerpage/project/detail', {
      layout: 'dashboard/developerpage/layouts/main',
...
exports.update = async (req, res) => {
  try {
    ...
    if (!project) {
      ...
      return res.redirect('/dashboard-developer/project-developer');
    }
    ...
    res.redirect('/dashboard-developer/project-developer');
  } catch (err) {
    console.error(err);
