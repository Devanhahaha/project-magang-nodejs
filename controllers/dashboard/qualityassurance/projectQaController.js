...
exports.index = async (req, res) => {
    try {
      ...
      const projects = await Project.findAll({
        where: {
          qa_id: userLoginId // ⬅️ Filter hanya project milik developer ini
        },
        include: [
          { model: User, as: 'admin' },
      ...
      res.render('dashboard/qualityassurancepage/project/index', {
        title: 'Projects',
...
exports.showByName = async (req, res) => {
  try {
    ...
    res.render('dashboard/qualityassurancepage/project/detail', {
      layout: 'dashboard/qualityassurancepage/layouts/main',
...
exports.update = async (req, res) => {
  try {
    ...
    res.redirect('/dashboard-qa/project-qa');
  } catch (err) {
    console.error(err);
